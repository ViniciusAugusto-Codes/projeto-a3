...
function Sapato() {
  return (
    <>
      ...
      <div>
        <h1 className="blusas">Sapatos:</h1>
        <div>
          <img className="blusa1" src="/assets/Imagens/Roupas/11.jpg" alt="blusa1" width="300" height="200" />
        </div>

        <div>
          <img className="blusa2" src="/assets/Imagens/Roupas/12.jpg" alt="blusa2" width="300" height="200" />
        </div>

        <div>
          <img className="blusa3" src="/assets/Imagens/Roupas/13.jpg" alt="blusa3" width="300" height="200" />
        </div>
